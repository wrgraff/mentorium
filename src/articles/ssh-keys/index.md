---
title: 'Как настроить ssh-ключи'
description: 'Чуть подробнее в дополнение к скринкасту о том, что именно мы делаем, как выйти из vim и какая есть альтернатива'
tags:
    - ssh
    - console
    - vim
